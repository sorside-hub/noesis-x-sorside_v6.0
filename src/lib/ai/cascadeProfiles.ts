 ...
 * Model urutan:
 * 1. gemini-3.7-flash (50/50 Key A -> Key B)
...
export function getGeminiFirstCascade(): CascadeStep[] {
  ...
  return [
    // Tier 1: Flagship Gemini (3.7 Flash)
    { provider: g1, model: 'gemini-3.7-flash' },
    { provider: g2, model: 'gemini-3.7-flash' },
 ...
 * 3. gemini-3.7-flash (Fallback Gemini Nalar, 50/50 Key A -> Key B)
...
export function getGroqFirstCascade(): CascadeStep[] {
  ...
  return [
    ...
    // Tier 3: Fallback ke Gemini Flagship (3.7 Flash)
    { provider: g1, model: 'gemini-3.7-flash' },
    { provider: g2, model: 'gemini-3.7-flash' },
